...
drop table costos cascade ;
drop table niveles_escolares cascade ;
drop table estados_civiles cascade ;
drop table nacionalidades cascade ;
drop table municipios_estados cascade ;
drop table grupos cascade ;
drop table statuses cascade ;
drop table materias cascade ;
drop table ciclos_escolares cascade ;
drop table maestros_materias cascade ;
drop table calificaciones cascade ;
drop table alumnos_grupos cascade ;
...
comment on column alumnos.nacimiento_lugar is 'toma los datos de la tabla municipios_estados';
